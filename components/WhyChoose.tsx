export default function WhyChoose() {
  ...
  return (
    <section className="whyChooseZusasa">
      ...
      <div className="whyChooseGrid">
        {reasons.map((reason, index) => (
          <article className="whyChooseCard" key={reason.title}>
      ...
      <div className="whyChooseCallout">
        <div>
          <span>Servicio local en Manzanillo</span>
          <h3>Transporte y resguardo de carga contenerizada para operaciones portuarias.</h3>
        </div>
